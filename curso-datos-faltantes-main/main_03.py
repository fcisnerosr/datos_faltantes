...
#  print(riskfactors_df.missing.missing_variable_summary()) #   Genera una tabla con información sobre valores faltantes: número de faltantes, total de observaciones y porcentaje por cada columna.
